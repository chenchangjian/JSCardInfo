...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/chenchangjian/JSCardInfo"
  ...
  s.source       = { :git => "https://github.com/chenchangjian/JSCardInfo.git", :tag => s.version.to_s }
  ...
  s.source_files  = "JSCardInfo/JSCardInfo/**/*.{h,m,swift}"
